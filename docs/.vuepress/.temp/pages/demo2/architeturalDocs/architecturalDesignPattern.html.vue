...
<p><strong>Model:</strong> The <strong>model</strong> in our system is the Nest.js backend, which encapsulates the business logic and communicates with the database. It comprises of all the services that control all business logic, and uses the specific repository classes to query the database.</p>
<p><strong>View:</strong> The <strong>view</strong> component in represents the user interface (UI) and how data is presented to the user. It’s responsible for rendering data from the <strong>model</strong> and handling user interactions. When important events like being assigned a job take place, users' views change accordingly.</p>
<p><strong>Controller:</strong> The Controller acts as an intermediary between the <strong>model</strong> and the <strong>view</strong>. It handles user input, processes requests, and communicates with the various services in the backend.</p>
