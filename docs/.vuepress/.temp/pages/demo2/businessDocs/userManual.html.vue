<template><div><h1 id="user-manual" tabindex="-1"><a class="header-anchor" href="#user-manual"><span>User Manual</span></a></h1>
<h2 id="overview" tabindex="-1"><a class="header-anchor" href="#overview"><span>Overview</span></a></h2>
<p>This is the user manual for WorkWise Central. The manual currently only reflects the aspects of the system that have been implemented. The document will be updated as development continues.</p>
<h2 id="clients" tabindex="-1"><a class="header-anchor" href="#clients"><span>Clients</span></a></h2>
<h3 id="add-a-client" tabindex="-1"><a class="header-anchor" href="#add-a-client"><span>Add a Client</span></a></h3>
<ol>
<li>
...
<h3 id="edit-a-client" tabindex="-1"><a class="header-anchor" href="#edit-a-client"><span>Edit a Client</span></a></h3>
<ol>
<li>
<p><strong>Navigate to the Clients Page</strong></p>
<ul>
...
<h3 id="delete-a-client" tabindex="-1"><a class="header-anchor" href="#delete-a-client"><span>Delete a Client</span></a></h3>
<ol>
<li>
<p><strong>Navigate to the Clients Page</strong></p>
<ul>
...
<p><strong>Submit the Form</strong></p>
<ul>
<li>Once all the information is filled out, click the &quot;Save&quot; or &quot;Submit&quot; button to add the job to the system.</li>
</ul>
</li>
</ol>
<h3 id="edit-a-job" tabindex="-1"><a class="header-anchor" href="#edit-a-job"><span>Edit a Job</span></a></h3>
<ol>
<li>
<p><strong>Navigate to the Jobs Page</strong></p>
<ul>
...
<h3 id="delete-a-job" tabindex="-1"><a class="header-anchor" href="#delete-a-job"><span>Delete a Job</span></a></h3>
<ol>
<li>
<p><strong>Navigate to the Jobs Page</strong></p>
<ul>
...
<h2 id="employees" tabindex="-1"><a class="header-anchor" href="#employees"><span>Employees</span></a></h2>
<h3 id="add-an-employee" tabindex="-1"><a class="header-anchor" href="#add-an-employee"><span>Add an Employee</span></a></h3>
<ol>
<li>
...
<li>
<p><strong>Fill Out Employee Information</strong></p>
<ul>
<li>Enter the necessary employee details such as name, contact information, job title, and assigned department.</li>
</ul>
</li>
<li>
<p><strong>Submit the Form</strong></p>
...
<h3 id="edit-an-employee" tabindex="-1"><a class="header-anchor" href="#edit-an-employee"><span>Edit an Employee</span></a></h3>
<ol>
<li>
<p><strong>Navigate to the Employees Page</strong></p>
<ul>
...
<li>
<p><strong>Update Employee Information</strong></p>
<ul>
<li>Modify the employee details as needed in the form that appears.</li>
</ul>
</li>
<li>
<p><strong>Submit the Changes</strong></p>
...
<h3 id="delete-an-employee" tabindex="-1"><a class="header-anchor" href="#delete-an-employee"><span>Delete an Employee</span></a></h3>
<ol>
<li>
<p><strong>Navigate to the Employees Page</strong></p>
<ul>
...
<p><strong>Confirm Deletion</strong></p>
<ul>
<li>Confirm the deletion action when prompted to permanently remove the employee from the system.</li>
</ul>
</li>
</ol>
<h2 id="conclusion" tabindex="-1"><a class="header-anchor" href="#conclusion"><span>Conclusion</span></a></h2>
<p>This user manual provides the basic steps to manage clients, jobs, and employees within the Service Delivery Management System. For further assistance or advanced functionalities, please refer to the additional documentation or contact support.</p>
</div></template>
