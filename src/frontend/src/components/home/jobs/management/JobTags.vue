  ...
  <v-card class="pa-4">
    ...
    <v-dialog v-model="dialog" max-width="400px">
      <v-card>
        ...
        <v-card-actions>
          <v-btn color="primary" @click="saveLabel">
...
const colorOptions = ref([
  ...
  '#4DB6AC', '#4DD0E1', '#4FC3F7', '#64B5F6', '#7986CB',
  '#BA68C8', '#DCE775', '#FFF59D', '#FFEB3B', '#FFCA28',
  '#FF7043', '#FF8A65', '#A1887F', '#90A4AE', '#78909C',
  '#EF5350', '#EC407A', '#AB47BC', '#8E24AA', '#7B1FA2',
  '#42A5F5', '#26A69A', '#66BB6A', '#9CCC65', '#FFEE58'
]);
