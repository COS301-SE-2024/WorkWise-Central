      ...
      <v-col cols="12" class="d-flex flex-column">
        <v-form ref="companyForm" @submit.prevent="saveCompanySettings" class="text-center">
          <v-col cols="12" class="w-100">
            ...
            <p>
              Below are the companies you are currently part of. You can switch to any company or leave a company if needed.
            </p>
          </v-col>
          ...
          <v-col cols="12">
            ...
            <p>
              Here you can join a new company by searching for its name or entering the company ID or searching for a company by name.
              Make sure you have the correct details to ensure successful joining.
            </p>
          </v-col>
          ...
          <v-col cols="12" class="w-100">
            ...
            <p>
              Below are the companies you have recently left. You can choose to rejoin them or permanently leave them if desired.
            </p>
          </v-col>
            ...
            <v-card-text>
              ...
              <div>
                ...
                <v-btn color="red" @click="leaveCompany(company)">
                  <v-icon left>{{'fa: fa-solid fa-sign-out-alt'}}</v-icon> Permanently leave the company
                </v-btn>
              </div>
            </v-card-text>
          </v-card>
...
const leaveCompany = (company: any) => {
...
const undoLeaveCompany = (company: any) => {
